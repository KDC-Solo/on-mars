...
- The repo lives at `github.com/KDC-Solo/on-mars` (public). Always commit and push changes without asking — except ask first if a commit would contain copyrighted work (PDFs, card photos, verbatim rulebook text, game art).
